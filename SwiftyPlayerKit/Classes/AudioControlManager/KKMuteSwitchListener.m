...
- (instancetype)init{
    if (self = [super init]){
        NSURL* url = [[[[[[[NSBundle mainBundle].bundleURL URLByAppendingPathComponent:@"KKMuteSwitchListener"] URLByAppendingPathExtension:@"bundle"] URLByAppendingPathComponent:@"KKMuteSwitchListener"] URLByAppendingPathExtension:@"bundle"] URLByAppendingPathComponent:@"silence"] URLByAppendingPathExtension:@"mp3"];
